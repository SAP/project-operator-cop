/*
SPDX-FileCopyrightText: 2023 SAP SE or an SAP affiliate company and project-operator-cop contributors
...
import (
	...
	operatorv1alpha1 "github.com/sap/project-operator-cop/api/v1alpha1"
	"github.com/sap/project-operator-cop/internal/transformer"
)

const Name = "project-operator-cop.cs.sap.com"
...
func (o *Operator) GetUncacheableTypes() []client.Object {
	return []client.Object{&operatorv1alpha1.ProjectOperator{}}
}
...
func (o *Operator) Setup(mgr ctrl.Manager, discoveryClient discovery.DiscoveryInterface) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.ProjectOperator](
		o.options.Name,
		mgr.GetClient(),
		discoveryClient,
